...
// description to the user. We'll use this later to send responses like
// 400 "Bad Request" when there's a problem with the request that the user
// sent.
...
// a convenience wrapper around clientError which sends a 404 "Not Found"
